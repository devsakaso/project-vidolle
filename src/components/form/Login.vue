<template>
  <v-row>
    <v-col cols="12" md="8">
      <v-card-text class="mt-12">
        <h1 class="text-center display-1 primary--text text--accent-3 mb-4">ログイン</h1>
          ...
          <h4 class="text-center my-4">メールアドレスとパスワードを入力してスタートしましょう。</h4>
    ...
    <v-col cals="12" md="4" class="primary accent-3">
      <v-card-text class="white--text mt-12">
        <h4 class="text-center display-1">こんにちは！</h4>
        <h5 class="text-center mt-2">登録がまだの方はこちら</h5>
      </v-card-text>
